...
const Testimonial = () => {
    ...
    const testimonials = [
        { name: "Mistry JInish", 
          testimonial: "I've rented cars from various companies, but the experience with Urban Comapny was exceptional." 
        },
        { name: "GJ Smith", 
           ...
           <Title title="What Our Customers Say" subTitle="Discover why discerning travelers choose StayVenture for their luxury accommodations around the world."/>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-18">
                {testimonials.map((testimonial, index) => (
                    ...
                    key={index} className="bg-green-200 p-6 rounded-xl shadow-lg hover:-translate-y-1 transition-all duration-500">
                        ...
                        <p className="text-black max-w-90 mt-4 ">"{testimonial.testimonial}"</p>
                    </motion.div>
                ))}
            </div>
        </div>
